USE [master]
GO
/****** Object:  Database [MyTestDB]    Script Date: 2019-11-11 8:11:35 PM ******/
CREATE DATABASE [MyTestDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'MyTestDB', FILENAME = N'C:\Users\dace.akmene\MyTestDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'MyTestDB_log', FILENAME = N'C:\Users\dace.akmene\MyTestDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
USE [MyTestDB]
GO
/****** Object:  Table [dbo].[Users]    Script Date: 2019-11-11 8:11:35 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Find_Users]    Script Date: 2019-11-11 8:11:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Get_Users]    Script Date: 2019-11-11 8:11:35 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
